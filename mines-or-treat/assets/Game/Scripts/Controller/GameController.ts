...
export default class GameController extends cc.Component {
  ...
  private initFake() {
    GameController.instance.getHeadBar().setCurrentBalance(1000000);
    GameController.instance.getFootBar().updateBet();
  }

  public initNewGame() {
    this.getGamePlay().initNewGame();
    this.getFootBar().changeMode(FOOTBAR_MODE.NEW_GAME);
  }
